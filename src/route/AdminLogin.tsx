      ...
      <main className="auth-main"><div className="auth-card">
        <div className="auth-content">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            <div className="auth-field-group"><label className="auth-label" htmlFor="admin-email">Admin email</label><input id="admin-email" className="auth-input" type="email" autoComplete="username" value={email} onChange={(event) => setEmail(event.target.value)} placeholder="admin@qcampus.local" required /></div>
